import Dark_Principal_Logo from '../assets/principal_logo_dark.svg'
import Light_Principal_Logo from '../assets/principal_logo_light.svg'
...
export default function Presentation({isLight}) {

    return (
      <article className="presentationMain">
        <img className='presentationMainImage' src={isLight ? Dark_Principal_Logo : Light_Principal_Logo} />
        <div className='presentationMainText'>
            <p className='presentationMainTextTitle'>
                <span style={{color: isLight ? 'black' : '#FFFFFF'}} className='presentationMainTextLittleTitle'> 
                    Hey, soy
                </span>
