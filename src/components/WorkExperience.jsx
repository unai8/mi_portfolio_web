...
export default function WorkExperience() {
    ...
    return (
      <article id='WorkExperience' className="WorkExperienceMain">
        ...
        <div className='WorkExperienceMainTimeline'>
            <div className='WorkExperienceMainTimelineElement'>
                <p className='WorkExperienceMainTimelineElementFirstTitle'>CiberSOC</p>
                <p className='WorkExperienceMainTimelineElementSecondTitle'>Satec · Contrato de prácticas</p>
                <p className='WorkExperienceMainTimelineElementThirdTitle'>abr. 2024 - may. 2024 · 2 meses</p>
                <p className='WorkExperienceMainTimelineElementFourthTitle'>Parque tecnológico Zamudio · Presencial</p>
                <p className='WorkExperienceMainTimelineElementDescription'>-Revisión y Análisis de Logs: Monitoreo y análisis continuo de los logs de seguridad para identificar posibles amenazas y actividades sospechosas.
 ...
 <br/> -Generación de Informes de Seguridad: Elaboración de informes detallados sobre eventos de seguridad y recomendaciones para mejorar la postura de seguridad de la empresa.</p>
            ...
            <div className='WorkExperienceMainTimelineElement'>
                ...
                <p className='WorkExperienceMainTimelineElementSecondTitle'>Ingecom Sistemas · Jornada completa</p>
                <p className='WorkExperienceMainTimelineElementThirdTitle'>jun. 2023 - sept. 2023 · 4 meses</p>
                <p className='WorkExperienceMainTimelineElementFourthTitle'>Lugaritz · Presencial</p>
                <p className='WorkExperienceMainTimelineElementDescription'>-Creación de aplicación escaneo de matrículas para Android, con React Native, PHP y SQL Server.
 ...
 <br/> -Tramitación de denuncias mediante APIs externas con PHP.</p>
            ...
            <div className='WorkExperienceMainTimelineElement'>
                ...
                <p className='WorkExperienceMainTimelineElementSecondTitle'>Michelin · Contrato de prácticas</p>
                <p className='WorkExperienceMainTimelineElementThirdTitle'>mar. 2023 - jun. 2023 · 4 meses</p>
